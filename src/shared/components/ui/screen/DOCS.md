...
The Screen component integrates with the global `KeyboardContext` ([KeyboardContext.tsx](../../context/keyboard/KeyboardContext.tsx)) to track keyboard state. The context provides:
