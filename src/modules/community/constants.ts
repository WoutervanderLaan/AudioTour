import type {CommunitySortOption} from './types'
 ...
 */
export const DEFAULT_SORT_OPTION: CommunitySortOption = 'rating'
 ...
 */
export const SORT_OPTIONS: Array<{label: string; value: CommunitySortOption}> =
  [
